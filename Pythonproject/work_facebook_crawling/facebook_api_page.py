...
# git page - https://github.com/dizwe/facebook-scraper-for-non-english-user/blob/master/facebook_page_scraper_python3.py
...
def write_csv(wan_data, num):
    with open('facebook_data_%s_%s.csv' % (since, until), 'wt', encoding = 'cp949') as file:  #, encoding='utf8'
        w = csv.writer(file)
