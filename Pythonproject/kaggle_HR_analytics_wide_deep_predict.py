...
참고 - https://www.kaggle.com/jgmartin/deep-wide-model-prediction/code
...
data = pd.read_csv('C:/Users/bevis/Downloads/kaggle_human-resources-analytics/HR_comma_sep.csv')
